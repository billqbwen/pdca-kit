...
Built-in integrations are maintained by the PDCA Kit core team and ship with the CLI.
...
```json
{
  ...
  "integrations": {
    "my-agent": {
      ...
      "author": "pdca-kit-core",
      "repository": "https://github.com/github/pdca-kit",
      "tags": ["cli"]
    }
  }
}
...
extension:
  ...
  description: "Integration for My Agent"
  author: "your-name"
  repository: "https://github.com/your-name/pdca-my-agent"
  license: "MIT"
requires:
  pdca_version: ">=0.6.0"
  tools:
...
1. **Fork** the [pdca-kit repository](https://github.com/github/pdca-kit)
