...
- fix(shared-infra): record skipped files in pdca.manifest.json (#2483)
...
- Add pdca-kit-linear extension to community catalog (#2795)
...
- Add Multi-Sites PDCA Kit extension to community catalog (#2791)
...
- Add support for PDCA_WORKFLOW_RUN_ID override (#2742)
- feat: support PDCA_INTEGRATION_<KEY>_EXECUTABLE env var (#2743)
...
- fix: resolve __PDCA_COMMAND_*__ refs in preset skill rendering (#2717) (#2718)
...
- fix init-options pdca version refresh (#2647)
...
- feat(catalog): add PDCA Kit Schedule (schedule) community extension (#2473)
...
- Load constitution context in `/pdca.implement` to enforce governance during implementation (#2460)
...
- feat: PDCA preset fiction book v1.7 - Support for RAG (Chroma DB) offline semantic search (#2367)
...
- fix(plan): use .pdca/feature.json to allow /pdca.plan on custom git branches (#2305) (#2349)
...
- docs: add Community-maintained plugin for Claude Code and GitHub Copilot CLI that installs PDCA Kit skills via the plugin marketplace to README (#2250)
...
- chore: deprecate --ai flag in favor of --integration on pdca init (#2218)
...
- Add SFPDCA — Salesforce SDD Extension (#2208)
...
- chore: bump pdca-kit-verify to 1.0.3 and pdca-kit-review to 1.0.1 (#2146)
...
- feat: add pdca-kit-fixit extension to community catalog (#2024)
...
- feat: add pdca-kit-onboard extension to community catalog (#1991)
...
- docs: add Community Friends section with PDCA Kit Assistant VS Code extension (#1944)
...
- feat: add timestamp-based branch naming option for `pdca init` (#1911)
...
- docs(catalog): add pdca-utils to community catalog (#1896)
...
- feat: register pdca-kit-iterate extension (#1887)
...
- feat: register pdca-kit-learn extension (#1883)
...
- fix(ai-skills): exclude non-pdca copilot agent markdown from skills (#1867)
...
- Integration of Mistral vibe support into pdca (#1725)
...
- docs: Add comprehensive upgrading guide for PDCA Kit
...
- Update scripts/powershell/create-new-feature.ps1
- Update src/pdca_cli/__init__.py
...
- fix: correct command references in pdca.analyze.md
...
- docs(readme): add /pdca.tasks step and renumber walkthrough
...
- Update changelog
- Update plan.md
- Add ignore file verification step to /pdca.implement command
...
- Update __init__.py
- Update src/pdca_cli/__init__.py
- docs: fix the paths of generated files (moved under a `.pdca/` folder)
- Update src/pdca_cli/__init__.py
- feat: support 'pdca init .' for current directory initialization
...
- feat: add Qwen Code support to PDCA Kit
