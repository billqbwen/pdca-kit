...
PDCA Kit is a toolkit for [Spec-Driven Development](concepts/sdd.md) (SDD), a methodology that puts specifications at the center of AI-assisted software development. Instead of jumping straight to code, you describe *what* to build, refine it through structured phases, and let your AI coding agent implement it.

<a href="installation.md" class="btn btn-primary btn-lg">Install PDCA Kit</a>&nbsp;
...
Run `pdca init` with your agent of choice and PDCA Kit sets up the right command files, context rules, and directory structures automatically. If your agent isn't listed, the `generic` integration is an escape hatch for any tool.
...
**200+ contributors** power the PDCA Kit ecosystem — from core integrations to entirely new development processes. Anyone can create and publish an extension, preset, or workflow.
...
<div class="nav-cards">
  ...
  <a href="local-development.md" class="nav-card">
    ...
    <span>Contribute to PDCA Kit</span>
  </a>
...
```bash
uvx --from git+https://github.com/github/pdca-kit.git
