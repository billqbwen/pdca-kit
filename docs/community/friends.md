...
Community projects that extend, visualize, or build on PDCA Kit:
...
- **[cc-pdca-kit](https://github.com/pdca-community/cc-pdca-kit)** — Community-maintained plugin for Claude Code and GitHub Copilot CLI that installs PDCA Kit skills via the plugin marketplace.
