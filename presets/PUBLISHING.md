...
This guide explains how to publish your preset to the PDCA Kit preset catalog, making it discoverable by `pdca preset search`.
...
6. **Testing**: Preset tested on real projects with `pdca preset add --dev`
...
preset:
  ...
  repository: "https://github.com/your-org/pdca-kit-preset-your-preset"
  license: "MIT"
...
- ✅ Command names use dot notation (e.g. `pdca.define`)
...
pdca preset add --dev /path/to/your-preset

# Verify templates resolve from your preset
pdca preset resolve spec-template

# Verify preset info
pdca preset info your-preset

# List installed presets
pdca preset list

# Remove when done testing
pdca preset remove your-preset
```
...
ls .claude/commands/pdca.*.md

# Check Copilot commands (if using Copilot)
ls .github/agents/pdca.*.agent.md

# Check Gemini commands (if using Gemini)
ls .gemini/commands/pdca.*.toml
```
...
```text
https://github.com/your-org/pdca-kit-preset-your-preset/archive/refs/tags/v1.0.0.zip
```

### 5. Test Installation from Archive

```bash
pdca preset add --from https://github.com/your-org/pdca-kit-preset-your-preset/archive/refs/tags/v1.0.0.zip
```
...
PDCA Kit uses a dual-catalog system:
...
### 1. Fork the pdca-kit Repository

```bash
git clone https://github.com/YOUR-USERNAME/pdca-kit.git
cd pdca-kit
```
...
```json
{
  ...
  "catalog_url": "https://raw.githubusercontent.com/github/pdca-kit/main/presets/catalog.community.json",
  "presets": {
    "your-preset": {
      ...
      "author": "Your Name",
      "version": "1.0.0",
      "download_url": "https://github.com/your-org/pdca-kit-preset-your-preset/archive/refs/tags/v1.0.0.zip",
      "repository": "https://github.com/your-org/pdca-kit-preset-your-preset",
      "license": "MIT",
      "requires": {
        "pdca_version": ">=0.1.0"
...
```markdown
| Your Preset Name | Brief description of what your preset does | N templates, M commands[, P scripts] | — | [repo-name](https://github.com/your-org/pdca-kit-preset-your-preset) |
```
...
- [ ] Preset tested with `pdca preset add --dev`
- [ ] Templates resolve correctly (`pdca preset resolve`)
...
Once verified, `verified: true` is set and the preset appears in `pdca preset search`.
