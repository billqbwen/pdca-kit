...
# Automatically commit changes after a PDCA Kit command completes.
...
_config_file="$REPO_ROOT/.pdca/extensions/git/git-config.yml"
_enabled=false
_commit_msg=""
...
if [ -z "$_commit_msg" ]; then
    _commit_msg="[PDCA Kit] Auto-commit ${_phase} ${_command_name}"
fi
