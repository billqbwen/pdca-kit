...
Extension system for [PDCA Kit](https://github.com/github/pdca-kit) - add new functionality without bloating the core framework.

## Extension Catalogs

PDCA Kit provides two catalog files with different purposes:

### Your Catalog (`catalog.json`)

- **Purpose**: Default upstream catalog of extensions used by the PDCA Kit CLI
- **Default State**: Empty by design in the upstream project - you or your organization populate a fork/copy with extensions you trust
- **Location (upstream)**: `extensions/catalog.json` in the GitHub-hosted pdca-kit repo
- **CLI Default**: The `pdca extension` commands use the upstream catalog URL by default, unless overridden
- **Org Catalog**: Point `PDCA_CATALOG_URL` at your organization's fork or hosted catalog JSON to use it instead of the upstream default
...
pdca extension search  # Now uses your organization's catalog instead of the upstream default
```
...
- **Submission**: Open to community contributions via [issue template](https://github.com/github/pdca-kit/issues/new?template=extension_submission.yml)
...
4. **Team members** can now discover and install them:
   - `pdca extension search` shows your curated catalog
   - `pdca extension add <name>` installs from your catalog
...
**Tradeoff**: Extensions installed this way won't appear in `pdca extension search` for other team members unless you also add them to your `catalog.json`.
...
See the [Community Extensions](https://github.github.io/pdca-kit/community/extensions.html) page for the full list of available community-contributed extensions.
...
3. **File an issue** using the [Extension Submission](https://github.com/github/pdca-kit/issues/new?template=extension_submission.yml) template with all required metadata
...
pdca extension search                  # See what's in your catalog
pdca extension add <extension-name>    # Install by name

# Direct from URL (bypasses catalog)
pdca extension add <extension-name> --from https://github.com/<org>/<repo>/archive/refs/tags/<version>.zip
