...
2. Edit configuration:
   ...
   ```bash
   vim .pdca/extensions/my-extension/my-extension-config.yml
   ```
...
export PDCA_MY_EXTENSION_CONNECTION_URL="https://custom-api.com"
export PDCA_MY_EXTENSION_CONNECTION_API_KEY="custom-key"
```
...
1. Check extension is installed: `pdca extension list`
2. Restart AI agent
...
- **Issues**: <https://github.com/your-org/pdca-kit-my-extension/issues>
- **PDCA Kit Docs**: <https://github.com/statsperform/pdca-kit>
