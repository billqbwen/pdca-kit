...
class HermesIntegration(SkillsIntegration):
    ...
    both the marker and all global ``pdca-*`` skills, matching the
    ...
    def setup(
        ...
        **opts: Any,
        ...
        ``~/.hermes/skills/pdca-<name>/SKILL.md`` where Hermes
        ...
        for src_file in templates:
            ...
            skill_content = (
                ...
                f"compatibility: "
                f"{_quote('Requires pdca-kit project structure with .pdca/ directory')}\n"
                f"metadata:\n"
            ...
            # Write directly to global ~/.hermes/skills/pdca-<name>/SKILL.md
    ...
    def teardown(
        ...
        *,
        ...
        removes all ``pdca-*`` skills under ``~/.hermes/skills/``.
        ...
        # Remove all global Hermes skills for pdca — these are always
        ...
        if global_skills_dir.is_dir():
            for skill_dir in sorted(global_skills_dir.iterdir()):
                if skill_dir.is_dir() and skill_dir.name.startswith("pdca-"):
                    try:
                        rmtree(skill_dir)
