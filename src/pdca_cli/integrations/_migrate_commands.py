...
def integration_switch(
    ...
    if installed_key:
        ...
        manifest_path = project_root / ".pdca" / "integrations" / f"{installed_key}.manifest.json"
    ...
    manifest = IntegrationManifest(
        target_integration.key, project_root, version=_get_pdca_version()
    )
...
def integration_upgrade(
    ...
    new_manifest = IntegrationManifest(key, project_root, version=_get_pdca_version())
