...
Antigravity uses ``.agents/skills/pdca-<name>/SKILL.md`` layout (enforced since v1.20.5).
"""
...
# Without this, agy emits ``/pdca.git.commit`` (which does not
# resolve) instead of ``/pdca-git-commit``.
_HOOK_COMMAND_NOTE = (
