"""Shared PDCA Kit infrastructure installation helpers."""
...
def load_pdca_manifest(
    ...
    *,
    ...
    manifest_path = project_path / ".pdca" / "integrations" / "pdca.manifest.json"
    if manifest_path.exists():
        try:
            manifest = IntegrationManifest.load("pdca", project_path)
    ...
    return IntegrationManifest("pdca", project_path, version=version)
...
def refresh_shared_templates(
    ...
    *,
    ...
    dest_templates = project_path / ".pdca" / "templates"
...
def install_shared_infra(
    ...
    *,
    ...
    if scripts_src.is_dir():
        dest_scripts = project_path / ".pdca" / "scripts"
                    ...
                    for src_path in variant_src.rglob("*"):
                        ...
                        if not write:
                            if bucket == "preserved":
                                ...
                                # ``.pdca/`` tree does not silently drop it (#2107).
