"""Version checking and self-update commands for pdca_cli.
...
GITHUB_API_LATEST = "https://api.github.com/repos/github/pdca-kit/releases/latest"


def _get_installed_version() -> str:
    """Return the installed pdca-cli distribution version or 'unknown'.
    ...
    try:
        return importlib.metadata.version("pdca-cli")
...
def self_check() -> None:
    ...
    if installed == "unknown":
        ...
        console.print("\nTo reinstall:")
        console.print("  uv tool install pdca-cli --force \\")
        console.print(f"    --from git+https://github.com/github/pdca-kit.git@{tag}")
        return
