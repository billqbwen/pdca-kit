"""Bundle path resolution and version lookup for pdca_cli.
...
def _locate_core_pack() -> Path | None:
    ...
    templates/, scripts/ etc. into pdca_cli/core_pack/ at build time.
...
def get_pdca_version() -> str:
    """Get current pdca-kit version."""
    try:
