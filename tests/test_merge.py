...
from pdca_cli import merge_json_files
from pdca_cli import handle_vscode_settings
...
def test_merge_vscode_realistic_scenario(tmp_path):
    ...
    # Check additions
    assert merged["chat.promptFilesRecommendations"]["pdca.pdca"] is True
    assert merged["chat.tools.terminal.autoApprove"][".pdca/scripts/bash/"] is True
