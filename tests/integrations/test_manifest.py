...
from pdca_cli.integrations.manifest import IntegrationManifest, _sha256
...
class TestManifestPersistence:
    ...
    def test_manifest_path(self, tmp_path):
        ...
        assert m.manifest_path == tmp_path / ".pdca" / "integrations" / "copilot.manifest.json"
...
class TestManifestLoadValidation:
    def test_load_non_dict_raises(self, tmp_path):
        path = tmp_path / ".pdca" / "integrations" / "bad.manifest.json"
    ...
    def test_load_filters_recovered_files_not_in_files(self, tmp_path):
        ...
        path = tmp_path / ".pdca" / "integrations" / "test.manifest.json"
        path.parent.mkdir(parents=True)
