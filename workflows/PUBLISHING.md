...
This guide explains how to publish your workflow to the PDCA Kit workflow catalog, making it discoverable by `pdca workflow search`.
...
1. **Valid Workflow**: A working `workflow.yml` that passes `pdca workflow run` validation
...
# Check validation
pdca workflow info ./workflow.yml
...
```text
https://raw.githubusercontent.com/your-org/pdca-kit-workflow-your-workflow/v1.0.0/workflow.yml
```

### 5. Test Installation from URL

```bash
pdca workflow add your-workflow
...
```json
{
  ...
  "catalog_url": "https://raw.githubusercontent.com/github/pdca-kit/main/workflows/catalog.community.json",
  "workflows": {
    "your-workflow": {
      "id": "your-workflow",
      ...
      "author": "Your Name",
      "version": "1.0.0",
      "url": "https://raw.githubusercontent.com/your-org/pdca-kit-workflow-your-workflow/v1.0.0/workflow.yml",
      "repository": "https://github.com/your-org/pdca-kit-workflow-your-workflow",
      "license": "MIT",
      "requires": {
        "pdca_version": ">=0.15.0"
      },
...
### Checklist
- [ ] Valid workflow.yml (passes `pdca workflow info`)
- [ ] README.md with description, inputs, and step graph
- [ ] LICENSE file included
- [ ] GitHub release created with raw YAML URL
- [ ] Workflow tested end-to-end with `pdca workflow run`
...
Once verified, the workflow appears in `pdca workflow search`.
